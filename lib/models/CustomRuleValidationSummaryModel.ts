 ...
 * @export
 * @class CustomRuleValidationSummaryModel
 */
 @JsonObject("CustomRuleValidationSummaryModel")
 export class CustomRuleValidationSummaryModel {
    /**
     * @type {string}
     * @memberof CustomRuleValidationSummaryModel
     */
