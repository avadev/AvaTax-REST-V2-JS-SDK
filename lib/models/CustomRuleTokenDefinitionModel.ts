 ...
 * @export
 * @class CustomRuleTokenDefinitionModel
 */
 @JsonObject("CustomRuleTokenDefinitionModel")
 export class CustomRuleTokenDefinitionModel {
    /**
     * @type {string}
     * @memberof CustomRuleTokenDefinitionModel
     */
