...
export default class AvaTaxClient {
  ...
  private apiVersion: string = '26.3.2';
...
This endpoint is secured and requires appropriate subscription and permission levels.
   ...
   * 
     * @param {number} companyId The ID number of the company to search
     * @param {number} certificateId The ID number of the certificate to search
   ...
   * 
     ...
     * @param {number} skip If nonzero, skip this number of results before returning data. Used with `$top` to provide pagination for large datasets.
     * @param {string} orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return {FetchResult<Models.CustomerSupplierWithCountryParamModel>}
   */
  
  getAllCustomersAndSuppliersWithCountryParams({ companyId, filter, top, skip, orderBy }: { companyId: number, filter?: string, top?: number, skip?: number, orderBy?: string }): Promise<FetchResult<Models.CustomerSupplierWithCountryParamModel>> {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/supplierandcustomers/withcountryparams`,
      parameters: {
        $filter: filter,
        $top: top,
        $skip: skip,
	 ...
	 var strClientId =
      ...
      '; JavascriptSdk; ' + this.apiVersion + '; ' +
      this.machineNM;   
    return this.restCall({ url: path, verb: 'get', payload: null, clientId: strClientId }, createFetchResultClass(Models.CustomerSupplierWithCountryParamModel));
  }
  ...
  listActiveCertificatesForCustomer({ companyId, customerCode }: { companyId: number, customerCode: string }): Promise<Models.ExemptionStatusModel> {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/customers/${customerCode}/certificates/active`,
      parameters: {}
    });
	 var strClientId =
      this.appNM +
  ...
  listInActiveCertificatesForCustomer({ companyId, customerCode }: { companyId: number, customerCode: string }): Promise<Models.ExemptionStatusModel> {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/customers/${customerCode}/certificates/inactive`,
      parameters: {}
    });
	 var strClientId =
      this.appNM +
  ...
  listAllUnitOfBasis({ filter, top, skip, orderBy }: { filter?: string, top?: number, skip?: number, orderBy?: string }): Promise<FetchResult<Models.UnitOfBasisModel>> {
    var path = this.buildUrl({
      url: `/api/v2/definitions/unitofbasis`,
      parameters: {
        $filter: filter,
        $top: top,
        $skip: skip,
   ...
   * 
     ...
     * @param {number} skip If nonzero, skip this number of results before returning data. Used with `$top` to provide pagination for large datasets.
     * @param {string} orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
     * @param {Enums.ContentScope} scope Optional query parameter to filter by Custom or All countries (default: All) (See ContentScope::* for a list of allowable values)
   * @return {FetchResult<Models.IsoCountryModel>}
   */
  
  listCountries({ filter, top, skip, orderBy, scope }: { filter?: string, top?: number, skip?: number, orderBy?: string, scope?: Enums.ContentScope }): Promise<FetchResult<Models.IsoCountryModel>> {
    var path = this.buildUrl({
   ...
   * 
     ...
     * @param {number} skip If nonzero, skip this number of results before returning data. Used with `$top` to provide pagination for large datasets.
     * @param {string} orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
     * @param {Enums.ContentScope} scope Optional query parameter to filter system, custom content or all regions (default: System) (See ContentScope::* for a list of allowable values)
   * @return {FetchResult<Models.IsoRegionModel>}
   */
  
  listRegionsByCountryAndTaxTypeAndTaxSubTypeAndRateType({ companyId, country, taxTypeId, taxSubTypeId, rateTypeId, jurisdictionTypeId, top, skip, orderBy, scope }: { companyId: number, country: string, taxTypeId: string, taxSubTypeId: string, rateTypeId: number, jurisdictionTypeId: string, top?: number, skip?: number, orderBy?: string, scope?: Enums.ContentScope }): Promise<FetchResult<Models.IsoRegionModel>> {
    var path = this.buildUrl({
   ...
   * 
     ...
     * @param {number} skip If nonzero, skip this number of results before returning data. Used with `$top` to provide pagination for large datasets.
     * @param {string} orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
     * @param {Enums.ContentScope} scope Optional query parameter to filter by System, Custom or All tax sub types (default: System) (See ContentScope::* for a list of allowable values)
   * @return {FetchResult<Models.TaxSubTypeModel>}
   */
  
  listTaxSubTypesByCountryAndTaxType({ country, taxTypeId, companyId, filter, top, skip, orderBy, scope }: { country: string, taxTypeId: string, companyId: number, filter?: string, top?: number, skip?: number, orderBy?: string, scope?: Enums.ContentScope }): Promise<FetchResult<Models.TaxSubTypeModel>> {
    var path = this.buildUrl({
   ...
   * 
     ...
     * @param {number} skip If nonzero, skip this number of results before returning data. Used with `$top` to provide pagination for large datasets.
     * @param {string} orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
     * @param {Enums.ContentScope} scope Optional query parameter to filter by System, Custom or All tax types (default: System) (See ContentScope::* for a list of allowable values)
   * @return {FetchResult<Models.TaxTypeModel>}
   */
  
  listTaxTypesByNexusAndCountry({ country, companyId, top, skip, orderBy, scope }: { country: string, companyId: number, top?: number, skip?: number, orderBy?: string, scope?: Enums.ContentScope }): Promise<FetchResult<Models.TaxTypeModel>> {
    var path = this.buildUrl({
   ...
   *
   * 
     * @param {Models.FirmClientLinkageModel} model FirmClientLinkage record
   * @return {Models.FirmClientLinkageOutputModel}
   */
  
  insertFirmClientLinkage({ model }: { model: Models.FirmClientLinkageModel }): Promise<Models.FirmClientLinkageOutputModel> {
    var path = this.buildUrl({
      url: `/api/v2/firmclientlinkages/insert`,
      parameters: {}
    });
	 var strClientId =
      this.appNM +
  ...
  updateFirmClientLinkage({ model }: { model: Models.FirmClientLinkageModel }): Promise<Models.FirmClientLinkageOutputModel> {
    var path = this.buildUrl({
      url: `/api/v2/firmclientlinkages`,
      parameters: {}
    });
   ...
   * 
     ...
     * @param {number} itemId The unique ID of the item for which you want to get additional HS Duty Details.
  ...
  updateItem({ companyId, id, isRecommendationSelected, isRecommendationRejected, model }: { companyId: number, id: number, isRecommendationSelected?: boolean, isRecommendationRejected?: boolean, model: Models.ItemModel }): Promise<Models.ItemModel> {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/items/${id}`,
      parameters: {
        isRecommendationSelected: isRecommendationSelected,
        isRecommendationRejected: isRecommendationRejected
      }
    });
	 var strClientId =
      this.appNM +
   ...
   * 
     * @param {number} companyId The ID of the company that this item belongs to.
     * @param {number} itemId The ID of the item you want to update.
     * @param {Models.ItemParameterModel[]} model The item parameter object you want to upsert.
   * @return {Models.ItemParameterModel[]}
   */
  
  upsertItemParameter({ companyId, itemId, model }: { companyId: number, itemId: number, model?: Models.ItemParameterModel[] }): Promise<Array<Models.ItemParameterModel>> {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/items/${itemId}/parameters`,
      parameters: {}
    });
	 var strClientId =
      ...
      '; JavascriptSdk; ' + this.apiVersion + '; ' +
      this.machineNM;   
    return this.restCall({ url: path, verb: 'put', payload: model, clientId: strClientId }, Array<Models.ItemParameterModel>);
  }
   ...
   * 
     ...
     * @param {number} skip If nonzero, skip this number of results before returning data. Used with `$top` to provide pagination for large datasets.
     * @param {string} orderBy A comma separated list of sort statements in the format `(fieldname) [ASC|DESC]`, for example `id ASC`.
   * @return {FetchResult<Models.RateItemModel>}
   */
  
  getVATRatesByCountry({ country, filter, top, skip, orderBy }: { country: string, filter?: string, top?: number, skip?: number, orderBy?: string }): Promise<FetchResult<Models.RateItemModel>> {
    var path = this.buildUrl({
      url: `/api/v2/taxcontent/rates/${country}`,
      parameters: {
        $filter: filter,
        $top: top,
        $skip: skip,
	 ...
	 var strClientId =
      ...
      '; JavascriptSdk; ' + this.apiVersion + '; ' +
      this.machineNM;   
    return this.restCall({ url: path, verb: 'get', payload: null, clientId: strClientId }, createFetchResultClass(Models.RateItemModel));
  }
   ...
   * 
     ...
     * @param {Models.VendorModel[]} model The list of vendor objects to be created
   * @return {Models.VendorModel[]}
   */
  
  createVendors({ companyId, model }: { companyId: number, model: Models.VendorModel[] }): Promise<Array<Models.VendorModel>> {
    var path = this.buildUrl({
	 ...
	 var strClientId =
      ...
      '; JavascriptSdk; ' + this.apiVersion + '; ' +
      this.machineNM;   
    return this.restCall({ url: path, verb: 'post', payload: model, clientId: strClientId }, Array<Models.VendorModel>);
  }
