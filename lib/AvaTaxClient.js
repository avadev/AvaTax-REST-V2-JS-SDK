...
export default class AvaTaxClient 
{
    ...
    constructor({ appName, appVersion, machineName, environment }) {
        ...
        this.clientId = appName + "; " + appVersion + "; JavascriptSdk; 2.17.3-48; " + machineName;
    }
     ...
     * @return TransactionModel
     */
    refundTransaction({ companyCode, transactionCode, model }) {
     ...
     * @return FileResult
     */
    getFilingAttachment({ companyId, worksheetId }) {
        var path = buildUrl('/api/v2/companies/{companyId}/filings/{worksheetId}/attachment', { 
