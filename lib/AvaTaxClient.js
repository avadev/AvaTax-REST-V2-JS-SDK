...
export default class AvaTaxClient {
   ...
   * @param number timeout      Specify the timeout for AvaTax requests; default value 2 minutes.
   */
  constructor({ appName, appVersion, machineName, environment, timeout = 120_000 }) {
