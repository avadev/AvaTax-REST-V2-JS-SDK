...
export default class AvaTaxClient 
{
    ...
    constructor({ appName, appVersion, machineName, environment }) {
        ...
        this.clientId = appName + "; " + appVersion + "; JavascriptSdk; 17.6.0-85; " + machineName;
    }
     ...
     * @param  string     		 bearerToken   The avalara identity bearer token
     * @return AvaTaxClient
     */
     ...
     * @return FetchResult
     */
    listCommunicationsServiceTypes({ id } = {}) {
     ...
     * @return FetchResult
     */
    listNexusByCountryAndRegion({ country, region } = {}) {
     ...
     * @return FetchResult
     */
    listFilingCalendars({ companyId, filter, top, skip, orderBy } = {}) {
