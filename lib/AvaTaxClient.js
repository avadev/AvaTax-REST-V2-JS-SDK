...
export default class AvaTaxClient 
{
    ...
    constructor({ appName, appVersion, machineName, environment }) {
        ...
        this.clientId = appName + "; " + appVersion + "; JavascriptSdk; 2.17.4-58; " + machineName;
    }
    ...
    listJurisdictionOverridesByAccount({ accountId, filter, include, top, skip, orderBy }) {
        var path = buildUrl('/api/v2/accounts/{accountId}/jurisdictionoverrides', { 
            "$filter": filter,
            "$include": include,
            "$top": top,
            "$skip": skip,
    ...
    getJurisdictionOverride({ accountId, id }) {
        var path = buildUrl('/api/v2/accounts/{accountId}/jurisdictionoverrides/{id}', { 
    ...
    requestNewAccount({ model }) {
        var path = buildUrl('/api/v2/accounts/request', { 
    ...
    auditTransaction({ companyCode, transactionCode }) {
        var path = buildUrl('/api/v2/companies/{companyCode}/transactions/{transactionCode}/audit', { 
    ...
    lockTransaction({ companyCode, transactionCode, model }) {
        var path = buildUrl('/api/v2/companies/{companyCode}/transactions/{transactionCode}/lock', { 
    ...
    refundTransaction({ companyCode, transactionCode, include, model }) {
        var path = buildUrl('/api/v2/companies/{companyCode}/transactions/{transactionCode}/refund', { 
            "$include": include 
        })
        return this.restCall(path, 'post', model);
    }
    ...
    getTransactionByCodeAndType({ companyCode, transactionCode, documentType, include }) {
        var path = buildUrl('/api/v2/companies/{companyCode}/transactions/{transactionCode}/types/{documentType}', { 
            "$include": include 
        })
        return this.restCall(path, 'get', null);
    }
    ...
    auditTransactionWithType({ companyCode, transactionCode, documentType }) {
        var path = buildUrl('/api/v2/companies/{companyCode}/transactions/{transactionCode}/types/{documentType}/audit', { 
     ...
     * @return FileResult
     */
    getFilingAttachment({ companyId, filingId }) {
        var path = buildUrl('/api/v2/companies/{companyId}/filings/{filingId}/attachment', { 
    ...
    getFilingAttachments({ companyId, year, month }) {
        var path = buildUrl('/api/v2/companies/{companyId}/filings/{year}/{month}/attachments', { 
    ...
    getFilingAttachmentsTraceFile({ companyId, year, month }) {
        var path = buildUrl('/api/v2/companies/{companyId}/filings/{year}/{month}/attachments/tracefile', { 
    ...
    getNexusByFormCode({ companyId, formCode }) {
        var path = buildUrl('/api/v2/companies/{companyId}/nexus/byform/{formCode}', { 
    ...
    downloadNoticeAttachment({ companyId, id }) {
        var path = buildUrl('/api/v2/companies/{companyId}/notices/files/{id}/attachment', { 
    ...
    uploadAttachment({ companyId, model }) {
        var path = buildUrl('/api/v2/companies/{companyId}/notices/files/attachment', { 
    ...
    listRateTypesByCountry({ country }) {
        var path = buildUrl('/api/v2/definitions/countries/{country}/ratetypes', { 
    ...
    listJurisdictionsByAddress({ line1, line2, line3, city, region, postalCode, country }) {
        var path = buildUrl('/api/v2/definitions/jurisdictionsnearaddress', { 
            "line1": line1,
            "line2": line2,
            "line3": line3,
            "city": city,
    ...
    listNexusByFormCode({ formCode }) {
        var path = buildUrl('/api/v2/definitions/nexus/byform/{formCode}', { 
    ...
    listResourceFileTypes({  }) {
        var path = buildUrl('/api/v2/definitions/resourcefiletypes', { 
    ...
    queryJurisdictionOverrides({ filter, include, top, skip, orderBy }) {
        var path = buildUrl('/api/v2/jurisdictionoverrides', { 
            "$filter": filter,
            "$include": include,
            "$top": top,
            "$skip": skip,
    ...
    bulkLockTransaction({ model }) {
        var path = buildUrl('/api/v2/transactions/lock', { 
