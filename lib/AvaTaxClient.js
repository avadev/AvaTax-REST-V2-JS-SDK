...
export default class AvaTaxClient {
   ...
   * @return object
   */
  copyAdvancedRule({ ruleId, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/advancedrules/rules/${ruleId}/copy`,
      parameters: {}
    });
   ...
   * @return object
   */
  createAdvancedRule({ model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/advancedrules/rules`,
      parameters: {}
    });
    return this.restCall({ url: path, verb: 'post', payload: model });
  }
   ...
   * @return object
   */
  createCompanyRuleExecution({ accountId, companyId, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/advancedrules/accounts/${accountId}/companies/${companyId}/executions`,
      parameters: {}
    });
    return this.restCall({ url: path, verb: 'post', payload: model });
  }
  ...
  deleteAdvancedRule({ ruleId } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/advancedrules/rules/${ruleId}`,
      parameters: {}
    });
    return this.restCall({ url: path, verb: 'delete', payload: null });
  }
   ...
   * @return object[]
   */
  deleteRuleExecution({ accountId, ruleExecutionId } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/advancedrules/accounts/${accountId}/executions/${ruleExecutionId}`,
      parameters: {}
    });
    return this.restCall({ url: path, verb: 'delete', payload: null });
  }
   ...
   * @return object
   */
  getAdvancedRuleByName({ name } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/advancedrules/rules/name/${name}`,
      parameters: {}
    });
    return this.restCall({ url: path, verb: 'get', payload: null });
  }
   ...
   * @return object
   */
  getAdvancedRuleCustomerDataSchema({ ruleId, accountId, companyId } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/advancedrules/accounts/${accountId}/companies/${companyId}/rules/${ruleId}/schema`,
      parameters: {}
    });
    return this.restCall({ url: path, verb: 'get', payload: null });
  }
   ...
   * @return FetchResult
   */
  getAdvancedRules({ fullDetails, includeTest, includeSystemRules } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/advancedrules/rules`,
      parameters: {
        fullDetails: fullDetails,
        includeTest: includeTest,
        includeSystemRules: includeSystemRules
      }
    });
    return this.restCall({ url: path, verb: 'get', payload: null });
  }
   ...
   * @return object
   */
  getAuditRecords({ accountId, fromDate, toDate } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/advancedrules/audits/accounts/${accountId}/from/${fromDate}/to/${toDate}`,
      parameters: {}
    });
    return this.restCall({ url: path, verb: 'get', payload: null });
  }
   ...
   * @return FetchResult
   */
  getCompaniesUsingAdvancedRule({ ruleId } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/advancedrules/rules/${ruleId}/companies`,
      parameters: {}
    });
    return this.restCall({ url: path, verb: 'get', payload: null });
  }
   ...
   * @return FetchResult
   */
  getCompanyRuleExecutions({ accountId, companyId, effectiveDate } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/advancedrules/accounts/${accountId}/companies/${companyId}/executions`,
      parameters: {
   ...
   * @return object
   */
  getRuleExecution({ accountId, ruleExecutionId } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/advancedrules/accounts/${accountId}/executions/${ruleExecutionId}`,
      parameters: {}
    });
   ...
   * @return object
   */
  updateAdvancedRule({ ruleId, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/advancedrules/rules/${ruleId}`,
      parameters: {}
    });
   ...
   * @return object
   */
  updateAdvancedRuleApproval({ ruleId, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/advancedrules/rules/${ruleId}/approve`,
      parameters: {}
    });
    return this.restCall({ url: path, verb: 'post', payload: model });
  }
   ...
   * @return object
   */
  updateAdvancedRuleVisibility({ ruleId, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/advancedrules/rules/${ruleId}/visible`,
      parameters: {}
    });
    return this.restCall({ url: path, verb: 'put', payload: model });
  }
   ...
   * @return FetchResult
   */
  updateCompanyRuleExecutionOrder({ accountId, companyId, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/advancedrules/accounts/${accountId}/companies/${companyId}/executions/order`,
      parameters: {}
    });
    return this.restCall({ url: path, verb: 'post', payload: model });
  }
   ...
   * @return object
   */
  updateRuleExecution({ accountId, ruleExecutionId, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/advancedrules/accounts/${accountId}/executions/${ruleExecutionId}`,
      parameters: {}
    });
   ...
   * @return object[]
   */
  createCSCustomers({ companyId, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/supplierandcustomers/customers`,
      parameters: {}
    });
    return this.restCall({ url: path, verb: 'post', payload: model });
  }
   ...
   * @return object[]
   */
  createCSSuppliers({ companyId, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/supplierandcustomers/suppliers`,
      parameters: {}
    });
    return this.restCall({ url: path, verb: 'post', payload: model });
  }
   ...
   * @return object[]
   */
  createCustomerCountryParam({ companyId, customerCode, countryCode, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/supplierandcustomers/customers/${customerCode}/${countryCode}`,
      parameters: {}
    });
    return this.restCall({ url: path, verb: 'post', payload: model });
  }
   ...
   * @return object[]
   */
  createSupplierCountryParams({ companyId, supplierCode, countryCode, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/supplierandcustomers/suppliers/${supplierCode}/${countryCode}`,
      parameters: {}
    });
    return this.restCall({ url: path, verb: 'post', payload: model });
  }
   ...
   * @return object[]
   */
  deleteCSCustomer({ companyId, customerCode } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/supplierandcustomers/customers/${customerCode}`,
      parameters: {}
    });
    return this.restCall({ url: path, verb: 'delete', payload: null });
  }
   ...
   * @return object[]
   */
  deleteCSSupplier({ companyId, supplierCode } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/supplierandcustomers/suppliers/${supplierCode}`,
      parameters: {}
    });
    return this.restCall({ url: path, verb: 'delete', payload: null });
  }
   ...
   * @return object[]
   */
  deleteCustomerCountryParam({ companyId, customerCode, countryCode } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/supplierandcustomers/customers/${customerCode}/${countryCode}`,
      parameters: {}
    });
   ...
   * @return object[]
   */
  deleteSupplierCountryParam({ companyId, supplierCode, countryCode } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/supplierandcustomers/suppliers/${supplierCode}/${countryCode}`,
      parameters: {}
    });
   ...
   * @return object
   */
  getCSCustomer({ companyId, customerCode } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/supplierandcustomers/customers/${customerCode}`,
      parameters: {}
    });
   ...
   * @return object
   */
  getCSSupplier({ companyId, supplierCode } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/supplierandcustomers/suppliers/${supplierCode}`,
      parameters: {}
    });
   ...
   * @return object
   */
  getCustomerCountryParam({ companyId, customerCode, countryCode } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/supplierandcustomers/customers/${customerCode}/${countryCode}`,
      parameters: {}
    });
   ...
   * @return object
   */
  getSupplierCountryParam({ companyId, supplierCode, countryCode } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/supplierandcustomers/suppliers/${supplierCode}/${countryCode}`,
      parameters: {}
    });
   ...
   * @return FetchResult
   */
  listCustomers({ companyId, filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/supplierandcustomers/customers`,
      parameters: {
        $filter: filter,
   ...
   * @return FetchResult
   */
  listSuppliers({ companyId, filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/supplierandcustomers/suppliers`,
      parameters: {
        $filter: filter,
   ...
   * @return object
   */
  updateCSCustomer({ companyId, customerCode, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/supplierandcustomers/customers/${customerCode}`,
      parameters: {}
    });
   ...
   * @return object
   */
  updateCSSupplier({ companyId, supplierCode, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/supplierandcustomers/suppliers/${supplierCode}`,
      parameters: {}
    });
   ...
   * @return object
   */
  updateCustomerCountryParam({ companyId, customerCode, countryCode, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/supplierandcustomers/customers/${customerCode}/${countryCode}`,
      parameters: {}
    });
   ...
   * @return object
   */
  updateSupplierCountryParam({ companyId, supplierCode, countryCode, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/supplierandcustomers/suppliers/${supplierCode}/${countryCode}`,
      parameters: {}
    });
  ...
  getTaxRate({ id } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/compliance/taxrates/${id}`,
      parameters: {}
    });
    return this.restCall({ url: path, verb: 'get', payload: null });
  }
  ...
  getTaxRegion({ id } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/compliance/taxregions/${id}`,
      parameters: {}
    });
    return this.restCall({ url: path, verb: 'get', payload: null });
  }
   ...
   * @return object
   */
  queryJurisdictionRates({ effectiveDate, endDate, filter, include, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/compliance/jurisdictionrates`,
      parameters: {
        effectiveDate: effectiveDate,
        endDate: endDate,
        $filter: filter,
   ...
   * @return object
   */
  queryJurisdictions({ country, region, effectiveDate, endDate, aggregationOption, include, top, skip } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/compliance/jurisdictions/${country}/${region}`,
      parameters: {
        effectiveDate: effectiveDate,
        endDate: endDate,
   ...
   * @return object
   */
  queryTaxRates({ filter, include, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/compliance/taxrates`,
      parameters: {
        $filter: filter,
        $include: include,
        $top: top,
   ...
   * @return object
   */
  queryTaxRegionJurisdictions({ filter, include, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/compliance/taxregionjurisdictions`,
      parameters: {
        $filter: filter,
        $include: include,
        $top: top,
   ...
   * @return object
   */
  queryTaxRegions({ filter, include, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/compliance/taxregions`,
      parameters: {
        $filter: filter,
        $include: include,
        $top: top,
   ...
   * @return FetchResult
   */
  queryCompanyCustomerAttributes({ companyid, filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/definitions/customerattributes`,
      parameters: {
        companyid: companyid,
        $filter: filter,
        $top: top,
   ...
   * @return object
   */
  getECMSById({ companyId, ecmsId, include } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/ecms/${ecmsId}`,
      parameters: {
        $include: include
      }
    });
   ...
   * @return FetchResult
   */
  listECMSByCompany({ companyId, filter, include, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/ecms`,
      parameters: {
        $filter: filter,
        $include: include,
        $top: top,
   ...
   * @return FetchResult
   */
  queryECMS({ filter, include, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/ecms`,
      parameters: {
        $filter: filter,
   ...
   * @return object
   */
  deleteErrorTransactions({ companyId, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/errortransactions`,
      parameters: {}
    });
   ...
   */
  listErrorCodes({ companyId, top, skip } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/errortransactions/errorcodes`,
      parameters: {
        $top: top,
        $skip: skip
      }
   ...
   * @return CappedFetchResult
   */
  listErrorTransactions({ companyId, filter, top, skip, orderBy } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/errortransactions`,
      parameters: {
        $filter: filter,
   ...
   * @return object[]
   */
  activePowerOfAttorney({ companyId, taxFormCode, country, region } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/filingcalendars/powerofattorney`,
      parameters: {
   ...
   * @return object[]
   */
  createUpdateCompanyReturnSettings({ companyId, filingCalendarId, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/filingcalendars/${filingCalendarId}/settings`,
      parameters: {}
    });
    return this.restCall({ url: path, verb: 'post', payload: model });
  }
   ...
   * @return FetchResult
   */
  queryFilingCalendarsPost({ returnCountry, returnRegion, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/filingcalendars/query`,
      parameters: {
        returnCountry: returnCountry,
        returnRegion: returnRegion
      }
   ...
   * @return FetchResult
   */
  queryFilingRequestsPost({ filingCalendarId, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/filingrequests/query`,
      parameters: {
        filingCalendarId: filingCalendarId
      }
    });
   ...
   * @return object[]
   */
  deleteReturnAdjustment({ companyId, id, type } = {}) {
    var path = this.buildUrl({
...
This gets the basic information from the filings and doesn't include anything extra.
   ...
   * @return FetchResult
   */
  getFilingsReturns({ companyId, endPeriodMonth, endPeriodYear, frequency, status, country, region, filingCalendarId, taxformCode } = {}) {
    var path = this.buildUrl({
   ...
   * @return object
   */
  updateLocationRemittance({ companyId, id, model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/locations/${id}/remittance`,
      parameters: {}
    });
    return this.restCall({ url: path, verb: 'put', payload: model });
  }
   ...
   * @return object
   */
  nexusSummary({ companyId } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/nexus/summary`,
      parameters: {}
    });
    return this.restCall({ url: path, verb: 'get', payload: null });
  }
   ...
   * @return FetchResult
   */
  queryNoticesPost({ model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/notices/query`,
      parameters: {}
    });
    return this.restCall({ url: path, verb: 'post', payload: model });
  }
   ...
   * @return object[]
   */
  certCaptureBridge({ model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/certcapturebridge`,
      parameters: {}
    });
    return this.restCall({ url: path, verb: 'post', payload: model });
  }
   ...
   * @return object
   */
  buildSendSalesRateFile({ model } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/sendsalescontent/download`,
      parameters: {}
    });
    return this.restCall({ url: path, verb: 'post', payload: model });
  }
   ...
   * @return object
   */
  downloadSendSalesRateFile({ date, taxCode, companyId, format, type } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/sendsalescontent/download/${companyId}/${taxCode}/${date}`,
      parameters: {
        format: format,
        type: type
      }
   ...
   * @return object
   */
  exportTaxProfile({ companyId } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyId}/taxprofile`,
      parameters: {}
    });
    return this.restCall({ url: path, verb: 'get', payload: null });
  }
   ...
   * @return object
   */
  importTaxProfile({ accountId, newCompanyCode, replaceAccountSettings, bypassNexusValidation, taxProfile } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/taxprofile`,
      parameters: {}
    });
    return this.restCall({ url: path, verb: 'post', payload: null });
  }
...
determination like nexus, exemption, product taxability etc.
   ...
   * @return object
   */
  inspectLine({ companyCode, transactionCode, lineNo, documentType } = {}) {
    var path = this.buildUrl({
      url: `/api/v2/companies/${companyCode}/transactions/${transactionCode}/lines/${lineNo}/inspect`,
      parameters: {
        documentType: documentType
      }
    });
