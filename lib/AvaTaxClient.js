...
export default class AvaTaxClient 
{
    ...
    constructor({ appName, appVersion, machineName, environment }) {
        ...
        this.clientId = appName + "; " + appVersion + "; JavascriptSdk; 17.7.0-96; " + machineName;
    }
    ...
    changeFilingStatus({ id, model } = {}) {
        var path = this.buildUrl({ url: `/api/v2/companies/${id}/filingstatus`, parameters: { 
     ...
     */
    getCompany({  } = {}) {
        var path = this.buildUrl({ url: `/api/v2/companies/mrs`, parameters: { 
    ...
    listCommunicationsServiceTypes({ id, filter, top, skip, orderBy } = {}) {
        var path = this.buildUrl({ url: `/api/v2/definitions/communications/transactiontypes/${id}/servicetypes`, parameters: { 
            "$filter": filter,
            "$top": top,
            "$skip": skip,
            "$orderBy": orderBy 
    ...
    listCommunicationsTransactionTypes({ filter, top, skip, orderBy } = {}) {
        var path = this.buildUrl({ url: `/api/v2/definitions/communications/transactiontypes`, parameters: { 
            "$filter": filter,
            "$top": top,
            "$skip": skip,
            "$orderBy": orderBy 
    ...
    listCommunicationsTSPairs({ filter, top, skip, orderBy } = {}) {
        var path = this.buildUrl({ url: `/api/v2/definitions/communications/tspairs`, parameters: { 
            "$filter": filter,
            "$top": top,
            "$skip": skip,
            "$orderBy": orderBy 
    ...
    listJurisdictions({ filter, top, skip, orderBy } = {}) {
        var path = this.buildUrl({ url: `/api/v2/definitions/jurisdictions`, parameters: { 
            "$filter": filter,
            "$top": top,
            "$skip": skip,
            "$orderBy": orderBy 
    ...
    createReturnPayment({ companyId, year, month, country, region, formCode, model } = {}) {
        var path = this.buildUrl({ url: `/api/v2/companies/${companyId}/filings/${year}/${month}/${country}/${region}/${formCode}/payment`, parameters: { 
    ...
    deleteReturnPayment({ companyId, id } = {}) {
        var path = this.buildUrl({ url: `/api/v2/companies/${companyId}/filings/payment/${id}`, parameters: { 
    ...
    filingsCheckupReport({ filingsId, companyId } = {}) {
        var path = this.buildUrl({ url: `/api/v2/companies/${companyId}/filings/${filingsId}/checkup`, parameters: { 
    ...
    getFilingReturn({ companyId, id } = {}) {
        var path = this.buildUrl({ url: `/api/v2/companies/${companyId}/filings/returns/${id}`, parameters: { 
...
This gets the basic information from the filings and doesn't include anything extra.
    ...
    getFilingsReturns({ companyId, endPeriodMonth, endPeriodYear, frequency, status, country, region } = {}) {
        var path = this.buildUrl({ url: `/api/v2/companies/${companyId}/filings/returns`, parameters: { 
    ...
    deleteResponsibilities({ companyId, noticeId, id } = {}) {
        var path = this.buildUrl({ url: `/api/v2/companies/${companyId}/notices/${noticeId}/responsibilities/${id}`, parameters: { 
    ...
    deleteRootCauses({ companyId, noticeId, id } = {}) {
        var path = this.buildUrl({ url: `/api/v2/companies/${companyId}/notices/${noticeId}/rootcauses/${id}`, parameters: { 
